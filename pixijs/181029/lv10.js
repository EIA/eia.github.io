...
var fragSrc = `
  ...
  vec2 warpAmount = vec2( 1.0 / 16.0, 1.0 / 16.0 );
  ...
  void main() {
    ...
    float mask = 0.;
    coord2 = mapCoord(coord2 ) / dimensions;
    mask = Rect(coord2, 0.4, 0.6, 0.0, 1.0, 0.05);
    coord2 = unmapCoord(coord2 * dimensions);
    gl_FragColor = mix(gl_FragColor, vec4(1.0, 1.0, 1.0, 1.0), mask);
...
var uniforms = { dimensions: { type: 'v2', value: [320, 186] }, mappedMatrix: { type: 'mat3', value: new PIXI.Matrix()}};
