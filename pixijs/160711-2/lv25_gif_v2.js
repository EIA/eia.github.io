...
var renderer = PIXI.autoDetectRenderer(STAGE_WIDTH, STAGE_HEIGHT,{backgroundColor : 0x1c1b18});
...
PIXI.loader
    .add('spritesheet', 'gifTest/gifSprite.json')
    .load(onAssetsLoaded);
function onAssetsLoaded()
{
	...
	for(var i = 0; i<rabbitCount; i++){
		...
		var bunny = new PIXI.extras.MovieClip(explosionTextures);
		bunny.gotoAndPlay(Math.random() * 120);
		// bunny.gotoAndPlay(1);
