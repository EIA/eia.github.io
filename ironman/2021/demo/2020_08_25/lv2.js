...
TweenMax.to(box2, 3, {y:app.screen.height / 2 - 100, yoyo: true, repeat:-1, ease:Strong.easeIn, yoyoEase:Strong.easeOut});
// box2.alpha = 0;
...
TweenMax.to(box3, 3, {y:app.screen.height / 2 - 100, yoyo: true, repeat:-1, ease:Strong.easeOut, yoyoEase:Strong.easeOut});
// box3.alpha = 0;