...
const topTest = new PIXI.Graphics();
app.stage.addChild(topTest);
topTest.name = 'topTest';
topTest.interactive = true;
...
function createAllBox(){
  ...
  const topTest2 = new PIXI.Graphics();
  container.addChild(topTest2);
  topTest2.name = 'topTest2';
  topTest2.interactive = true;

  topTest2.clear();
  topTest2.beginFill(0xff0000, .3);
  topTest2.drawRect(-100, 0, 300, 300);
  topTest2.endFill();
...
window.onresize = function (event){
  ...
  topTest.clear();
  topTest.beginFill(0xff9900, .3);
  // topTest.drawRect(app.renderer.width * -.5, app.renderer.height * -.5, app.renderer.width, app.renderer.height);
  topTest.drawRect(app.renderer.width * -.5, app.renderer.height * -.5, app.renderer.width*.5, app.renderer.height);
  topTest.endFill();
