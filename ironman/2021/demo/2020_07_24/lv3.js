...
grid.lineStyle(1, 0x0);
grid.moveTo(app.screen.width / 2 - 100, app.screen.height / 2);
grid.lineTo(app.screen.width / 2 + 100, app.screen.height / 2);

grid.moveTo(app.screen.width / 2 - 100, app.screen.height / 2 - 50);
grid.lineTo(app.screen.width / 2 - 100, app.screen.height / 2 + 50);
