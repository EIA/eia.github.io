...
const bunny1 = createLine();
const bunny2 = createLine();
const bunny3 = createLine();
const bunny1_2 = createLine();
const bunny2_2 = createLine();
const bunny3_2 = createLine();
const bunny1_3 = createLine();
const bunny2_3 = createLine();
const bunny3_3 = createLine();
const bunny1_4 = createLine();
const bunny2_4 = createLine();
const bunny3_4 = createLine();
...
mask1_3.beginTextureFill(mask1_3_texture)
mask1_3.drawRect(0, 0, 100, 100)
mask1_3.endFill();

const mask2_3 = new PIXI.Graphics();
mask2_3.beginTextureFill(mask2_3_texture)
mask2_3.drawRect(0, 0, 100, 100)
mask2_3.endFill();

const mask3_3 = new PIXI.Graphics();
mask3_3.beginTextureFill(mask3_3_texture)
mask3_3.drawRect(0, 0, 100, 100)
mask3_3.endFill();

const mask1_4 = new PIXI.Graphics();
mask1_4.beginTextureFill(mask1_4_texture)
mask1_4.drawRect(0, 0, 100, 100)
mask1_4.endFill();

const mask2_4 = new PIXI.Graphics();
mask2_4.beginTextureFill(mask2_4_texture)
mask2_4.drawRect(0, 0, 100, 100)
mask2_4.endFill();

const mask3_4 = new PIXI.Graphics();
mask3_4.beginTextureFill(mask3_4_texture)
mask3_4.drawRect(0, 0, 100, 100)
mask3_4.endFill();
